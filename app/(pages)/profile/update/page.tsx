...
const UpdateProfileForm = () => {
  ...
  const [availableInterests, setAvailableInterests] = useState<Interest[] | null>(null);
  ...
  // Fetch available skills and interests
  useEffect(() => {
      const fetchAvailableData = async () => {
          try {
              const [skillsData, interestsData] = await Promise.all([GetSkills(), GetInterests()]);
      ...
      const fetchUserData = async () => {
          try {
              ...
              form.reset({
                  ...
                  interests: userInterestsData?.map((interest) => interest.id.toString()) || [],
              });
          } catch (error) {
              toast({
